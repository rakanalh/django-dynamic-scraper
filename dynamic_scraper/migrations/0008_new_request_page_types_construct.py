    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_attr', models.ForeignKey(blank=True, to='dynamic_scraper.ScrapedObjAttr', help_text='Empty for main page, attribute of type URL scraped from main page for detail pages.', null=True, on_delete=models.SET_NULL)),
