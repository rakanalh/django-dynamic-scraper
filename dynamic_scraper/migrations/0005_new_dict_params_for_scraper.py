...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='scraper',
            name='request_type',
            field=models.CharField(default='R', help_text=b'Normal GET request (default) or form request via POST, using Scrapys corresponding request classes (not used for checker).', max_length=1, choices=[('R', 'Request (GET)'), ('F', 'FormRequest (POST)')]),
        ),
    ]
