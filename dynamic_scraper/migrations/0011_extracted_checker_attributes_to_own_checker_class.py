    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_attr', models.ForeignKey(help_text=b'Attribute of type DETAIL_PAGE_URL, several checkers for same DETAIL_PAGE_URL attribute possible.', to='dynamic_scraper.ScrapedObjAttr', on_delete=models.SET_NULL)),
                ('scraper', models.ForeignKey(to='dynamic_scraper.Scraper', on_delete=models.SET_NULL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, to='dynamic_scraper.ScrapedObjAttr', help_text=b'Empty for main page, attribute of type DETAIL_PAGE_URL scraped from main page for detail pages.', null=True, on_delete=models.SET_NULL),
        ),
