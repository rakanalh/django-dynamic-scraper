    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dynamic_scraper.ScrapedObjClass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_attr', models.ForeignKey(help_text='The different attributes to be scraped, exactly one attribute of type BASE necessary.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='dynamic_scraper.ScrapedObjAttr')),
                ('scraper', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dynamic_scraper.Scraper')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True)),
                ('scraped_obj_attr', models.ForeignKey(blank=True, help_text='Empty for main page, attribute of type DETAIL_PAGE_URL scraped from main page for detail pages.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='dynamic_scraper.ScrapedObjAttr')),
                ('scraper', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dynamic_scraper.Scraper')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True)),
                ('scraped_obj_attr', models.ForeignKey(help_text='Attribute of type DETAIL_PAGE_URL, several checkers for same DETAIL_PAGE_URL attribute possible.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='dynamic_scraper.ScrapedObjAttr')),
                ('scraper', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dynamic_scraper.Scraper')),
            ],
        ),
    ]
