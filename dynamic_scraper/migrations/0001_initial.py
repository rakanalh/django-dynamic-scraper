    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True)),
                ('scraped_obj_class', models.ForeignKey(to='dynamic_scraper.ScrapedObjClass', on_delete=models.SET_NULL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_attr', models.ForeignKey(to='dynamic_scraper.ScrapedObjAttr', on_delete=models.SET_NULL)),
        ...
        migrations.AddField(
            ...
            name='obj_class',
            field=models.ForeignKey(to='dynamic_scraper.ScrapedObjClass', on_delete=models.SET_NULL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='logmarker',
            name='scraper',
            field=models.ForeignKey(blank=True, to='dynamic_scraper.Scraper', null=True, on_delete=models.SET_NULL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='log',
