...
class ScrapedObjAttr(models.Model):
    ...
    obj_class = models.ForeignKey(ScrapedObjClass, null=True, on_delete=models.SET_NULL)
...
class Scraper(models.Model):
    ...
    name = models.CharField(max_length=200)
    scraped_obj_class = models.ForeignKey(ScrapedObjClass, null=True, on_delete=models.SET_NULL)
...
class Checker(models.Model):
    ...
    scraped_obj_attr = models.ForeignKey(ScrapedObjAttr, help_text="Attribute of type DETAIL_PAGE_URL, several checkers for same DETAIL_PAGE_URL attribute possible.", null=True, on_delete=models.SET_NULL)
    scraper = models.ForeignKey(Scraper, null=True,  on_delete=models.SET_NULL)
...
class ScraperElem(models.Model):
    ...
    scraped_obj_attr = models.ForeignKey(ScrapedObjAttr, help_text=help_text, null=True, on_delete=models.SET_NULL)
    scraper = models.ForeignKey(Scraper, null=True,  on_delete=models.SET_NULL)
